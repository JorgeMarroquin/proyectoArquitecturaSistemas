node {
    ...
    try{
        ...
        stage("Correo final"){
            mail bcc: '', body: "Pipeline JENKINS succes ${env.BRANCH_NAME}", cc: '', from: '', replyTo: '', subject: "La pipeline #${BUILD_NUMBER} ha finalizado con éxito", to: 'marroquin181358@unis.edu.gt, jorge.marroquin.ochoa@gmail.com'
        }
    }catch(e){
        stage("Correo final"){
            mail bcc: '', body: "Pipeline JENKINS failed ${env.BRANCH_NAME}", cc: '', from: '', replyTo: '', subject: "La pipeline #${BUILD_NUMBER} ha finalizado con errores", to: 'marroquin181358@unis.edu.gt, jorge.marroquin.ochoa@gmail.com'
        }
    }
